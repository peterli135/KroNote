...
import TimelineMain from "../Components/Timeline/TimelineMain/TimelineMain";
...
function Individual() {
  ...
  const { docs } = useFirestore("family-timeline");
  const docCollectionName = "family-timeline";
  ...
  return (
    <>
      <header>
        <nav className="navbar__content">
          ...
          <div className="navbar__content__container">
            ...
            <Link to="/family" className="navbar__content__links active">
              Family
            </Link>
      ...
      <div className="timeline__background">
        ...
        <TimelineMain docs={docs} docCollectionName={docCollectionName} />
      </div>
    </>
  );
}
